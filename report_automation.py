# Membuat Automated Reporting (Table & Grafik), dan dikirim ke discord
# Dataset - https://www.kaggle.com/datasets/aungpyaeap/supermarket-sales

import pandas as pd # pandas untuk membuat dataframe(df)
from openpyxl import load_workbook # untuk berinteraksi antara python dan excel file - https://openpyxl.readthedocs.io/en/latest/api/openpyxl.worksheet.worksheet.html
...
wb.active.column_dimension = dim_holder
